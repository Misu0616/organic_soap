...
<body>
	<jsp:include page="../include/headerLogin.jsp" />
            <div id="div">
                ...
                <form name="ordFrm2" method="post" action="dvPlace2Servlet">
                    <div class="dvInfo"><p id="bold">배송 정보</p>  
                        ...
                        <p/> 
                        <% System.out.println("mem_key 값은 " + mem_key);
	                        Vector<r_inform> vlist = null;
	                    	vlist = oMgr.getdvPlace2(Integer.parseInt(mem_key));
                            ...
                            <input type="text" class="inputline" id="person" name="receive" value="<%= dto.getR_name() %>" placeholder="수령인" size="32">
                            <label for="number"></label>
                            <input type="tel" class="inputline" id="number" name="phonenum2" value="<%= dto.getR_phone() %>" placeholder="연락처" size="31.8">
                        <p/>
                            <label for="addrn"></label>
                            <input type="text" class="inputline" id="postal" name="addn" value="<%= dto.getR_postal_code() %>" placeholder="우편번호" size="14">
                            <button type="button" name="findaddr" value="주소 찾기" class="find_addr" onclick="openCenter('', 'pop', 500, 500);">주소 찾기</button>
                        <p/>
                            <label for="addr"></label>
                            <input type="text" class="inputline" id="addr1" name="adr" value="<%= dto.getR_address1() %>" placeholder="주소" size="70">
                        <p/>
                            <label for="det"></label>
                            <input type="text" class="inputline" id="addr2" name="detadr" value="<%= dto.getR_address2() %>" placeholder="상세주소" size="70">
                        <p/>
                            <p id="bold">배송 메모</p> 
                            <p/>
                       ...
                       <%
                        ...
                        <p/>
                    <div>
                        <button type="submit" class="finalpay" name="paylast" value="lastpay">다음으로</button>
                    </div>
                </form>
                <form name="ord1" method="post" action="order1.jsp">
