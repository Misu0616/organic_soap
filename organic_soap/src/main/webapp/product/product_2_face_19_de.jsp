            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="wishServlet">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_19.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_19.png" class="small">
                                 <img src="../images/face_19_1.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>아이가꿈 DIY 키트 북극곰</h1>
                            <h2>17,000원</h2>
                            <div id="heart"> 
                ...
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="30">
					<input type="hidden" name="cart_mem_key" value="<%= mem_key%>">
					
                            <div class="tt">
                                <p><b>멸종위기동물 비누 DIY 키트로 만드는 아이들의 손씻기 습관</b></p>
                                <br>
                                <br>
                                <h3>아이가꿈 DIY 키트 북극곰</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                                    ...
                                    <div class="total_price">
                                       <div class="total_price1"><b>총 합계금액</b></div>
                                        <div class="total_price2">
                                            <strong id="price">17000</strong> 원
                                        </div>                                              
                                    </div>
                                    <p/>
                                    <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_19_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_19_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_19_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_19_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 17000) +17000;
