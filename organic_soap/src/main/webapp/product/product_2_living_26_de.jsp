            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/living_26.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/living_26.png" class="small">
                                 <img src="../images/living_26_1.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>순면 비누 거품망</h1>
					...
					<form name="pro" method="post" action="productServlet">				
						...
						<input type="hidden" name="cart_pro_key" value="58">
						<input type="hidden" id="mm1" name="cart_mem_key" value="<%= mem_key%>">
						
                            <div class="tt">
                                <p><b>미세플라스틱 걱정없이 풍성한 거품을 내주는 순면 비누 거품망</b></p>
                                <br>
                                <br>
                                <h3>순면 비누 거품망</h3>
                                <p><b>배송 방법</b> 택배</p>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_26_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_living_26_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_living_26_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_living_26_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <div>
                	<img class="de4" src="../images/living_26_1.jpg">
