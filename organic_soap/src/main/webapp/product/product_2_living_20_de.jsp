            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="living_20.png"> 
					<input type="hidden" name="pro_name" value="수세미 기본형"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					         
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/living_20.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/living_20.png" class="small">
                                 <img src="../images/living_20_1.png" class="small">
                                 <img src="../images/living_20_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>수세미 기본형</h1>
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>수세미를 삶고 세척한 후 압축하여 재봉한 100%수세미</b></p>
                                <br>
                                <br>
                                <h3>수세미 기본형</h3>
                                <p><b>배송 방법</b> 택배</p>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_20_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_living_20_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_living_20_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_living_20_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <div class="de1">
                    <img src="../images/living_20_1.jpg">
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 4000) +4000;
