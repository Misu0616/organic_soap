            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="living_3.png"> 
					<input type="hidden" name="pro_name" value="리포레스트 인센스 세트"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					           
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/living_3.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/living_3.png" class="small">
                                 <img src="../images/living_3_1.png" class="small">
                                 <img src="../images/living_3_2.png" class="small">
                                 <img src="../images/living_3_3.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>리포레스트 인센스 세트</h1>
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>한국 전통 방식으로 포근한 나무의 향기를 담아 일상 속 나의 마음을 다독이는 인센스 스틱과 산불 피해목을 활용한 재날림 방지 인센스 홀더</b></p>
                                <br>
                                <br>
                                <h3>리포레스트 인센스 세트</h3>
                                <p><b>배송 방법</b> 택배</p>
                                    ...
                                    <div class="total_price">
                                       <div class="total_price1"><b>총 합계금액</b></div>
                                        <div class="total_price2">
                                            <strong id="price">40000</strong> 원
                                        </div>                                              
                                    </div>
                                    <p/>
                                    <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_3_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_living_3_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_living_3_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_living_3_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 40000) +40000;
