            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="face_6.png"> 
					<input type="hidden" name="pro_name" value="올바른 바디스크럽바 씨솔트"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					          
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_6.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_6.png" class="small">
                                 <img src="../images/face_6_1.png" class="small">
                                 <img src="../images/face_6_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>올바른 바디스크럽바 씨솔트</h1>
                            <h2>12,000원</h2>
                            <div id="heart"> 
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>청정 갯벌인 신안 천일염 성분이 바디 피부를 유연하게, 스크럽과 샤워를 한 번에 도와주는 바디스크럽바</b></p>
                                <br>
                                <br>
                                <h3>올바른 바디스크럽바 씨솔트</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                                    ...
                                    <div class="total_price">
                                       <div class="total_price1"><b>총 합계금액</b></div>
                                        <div class="total_price2">
                                            <strong id="price">12000</strong> 원
                                        </div>                                              
                                    </div>
                                    <p/>
                                    <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_6_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_6_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_6_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_6_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 12000) +12000;
