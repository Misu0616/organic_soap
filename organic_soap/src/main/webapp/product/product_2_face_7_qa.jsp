             ...
             <div class="every">
                ...
                <form name="pro" method="post"> 
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_7_de.jsp" style="color: rgb(93, 93, 93)">DETAIL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                ...
                                <div id="menu4"><a href="product_2_face_7_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Q&A</b></a></div>
                            </div>
                        </div>
                     </div> 
                <!--Q%A시작--> 
