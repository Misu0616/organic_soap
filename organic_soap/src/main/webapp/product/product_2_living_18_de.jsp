             ...
             <div class="every">
                ...
                <form name="pro" method="post" action="">	
					...
					<form name="pro" method="post" action="productServlet">				
						...
						<input type="hidden" name="cart_pro_key" value="50">
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_18_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                ...
                <div class="de1">
                    <img src="../images/living_18_1.jpg">
                    <img src="../images/living_18_2.jpg">
