            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="wishServlet">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_3.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_3.png" class="small">
                                 <img src="../images/face_3_1.png" class="small">
                                 <img src="../images/face_3_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>페이스 앤 바디바 레몬그라스</h1>
                            <h2>11,000원</h2>
                            <div id="heart"> 
                ...
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="15">
					<input type="hidden" name="cart_mem_key" value="<%= mem_key%>">
					
                            <div class="tt">
                                <p><b>싱그러운 레몬그라스 향으로 페이스와 바디를 한번에 클렌징 가능한 올인원바</b></p>
                                <br>
                                <br>
                                <h3>페이스 앤 바디바 레몬그라스</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_3_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_3_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_3_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_3_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
