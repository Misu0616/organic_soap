            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form>     
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_18.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_18.png" class="small">
                                 <img src="../images/face_18_1.png" class="small">
                                 <img src="../images/face_18_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>가꿈비누 상추</h1>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_18_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_18_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_18_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_18_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <!-- 본문 끝 -->
                <!-- 푸터 시작 -->
                	<%@include file="../include/footer.jsp" %><p/> href="../privacy.jsp"><span>개인정보처리방침</span></a> ｜ <a href="../terms.jsp"><span>이용약관</span></a></p>
                <!-- 푸터 끝 -->
            </div> 
        </div>
    </body>
