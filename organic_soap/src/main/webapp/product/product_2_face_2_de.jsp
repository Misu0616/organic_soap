            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="wishServlet">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_2.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                <img src="../images/face_2.png" class="small">
                            <img src="../images/face_2_1.png" class="small">
                            <img src="../images/face_2_2.png" class="small">
                             </div>
                        </div>
                        <div id="text">
                            <h1>앰플 세안바 다시마 폼클렌징</h1>
                            <h2>18,000원</h2>
                            <div id="heart"> 
                ...
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="14">
					<input type="hidden" name="cart_mem_key" value="<%= mem_key%>">
					
                            <div class="tt">
                                <p><b>청정지역 완도의 업사이클링 다시마가 쫀쫀한 앰플 거품을 만들어 매끈한 피부결을 선사</b></p>
                                <br>
                                <br>
                                <h3>앰플 세안바 다시마 폼클렌징</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_2_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_2_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_2_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_2_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
