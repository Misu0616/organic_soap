            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="hair_11.png"> 
					<input type="hidden" name="pro_name" value="올바른 샴푸바 쿨링용"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					           
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/hair_11.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/hair_11.png" class="small">
                                 <img src="../images/hair_11_1.png" class="small">
                                 <img src="../images/hair_11_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>올바른 샴푸바 쿨링용</h1>
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>시원한 쿨링감이 느껴지는 올바른 샴푸바 쿨링용</b></p>
                                <br>
                                <br>
                                <h3>올바른 샴푸바 쿨링용</h3>
                                <p><b>배송 방법</b> 택배</p>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_hair_11_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_hair_11_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_hair_11_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_hair_11_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <!-- 본문 끝 -->
                <!-- 푸터 시작 -->
                <%@include file="../include/footer.jsp" %><p/>                <!-- 푸터 끝 -->
            </div> 
        </div>
    </body>
</html>
