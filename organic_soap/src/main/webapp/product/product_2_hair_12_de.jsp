            ...
            <!-- 본문 시작 -->
             <div class="every">
                 ...
                 <form name="pro" method="post" action="">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            ...
                            <div id="small-pic">
                                 <img src="../images/hair_12.png" class="small">
                                 <img src="../images/hair_12_1.png" class="small">
                                 <img src="../images/hair_12_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>올바른 샴푸바 지성용</h1>
                ...
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="11">
					<input type="hidden" id="mm1" name="cart_mem_key" value="<%= mem_key%>">
					
                            <div class="tt">
                                <p><b>기름지고, 가려운 머리가 고민이라면 샴푸바 지성용</b></p>
                                <br>
                                <br>
                                <h3>올바른 샴푸바 지성용</h3>
                                <p><b>배송 방법</b> 택배</p>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_hair_12_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_hair_12_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_hair_12_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_hair_12_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
