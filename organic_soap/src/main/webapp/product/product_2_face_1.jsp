            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form>     
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_1.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                <img src="../images/face_1.png" class="small">
                                <img src="../images/face_1_1.png" class="small">
                             </div>
                        </div>
                        <div id="text">
                            <h1>릴랙싱 모먼트 배쓰밤 입욕제 세트</h1>
                            <h2>28,000원</h2>
                            <div id="heart"> 
                                <span class="material-symbols-outlined" id="icon" onclick="style.color='red',save()">favorite </span>
                            </div>
                            <hr>
                            <div class="tt">
                                <p><b><!--제품 설명 --></b></p>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_1_de.jsp" style="color: rgb(93, 93, 93)">DETAIL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_1_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_1_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_1_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <div>  
                    <img class="de1" src="../images/face_1_0.png">
                    <img id="de2" src="../images/face_1_1.jpg">
                    <img id="de2" src="../images/face_1_2.jpg">
                    <img id="de2" src="../images/face_1_3.jpg">
                    <img id="de2" src="../images/face_1_4.jpg">
                    <img class="de3" src="../images/all.jpg">
                </div>
                <div id="table_info">
                    <table class="info">
