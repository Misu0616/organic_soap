            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="living_15.png"> 
					<input type="hidden" name="pro_name" value="올바른 설거지 워싱바 300g"> 
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                ...
                                <div id="menu2"><a href="product_2_living_15_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;<b>GUIDE</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
