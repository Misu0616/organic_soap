            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="living_11.png"> 
					<input type="hidden" name="pro_name" value="친환경 고체 세탁 세제 70정"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					             
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/living_11.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/living_11.png" class="small">
                                 <img src="../images/living_11_1.png" class="small">
                                 <img src="../images/living_11_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>친환경 고체 세탁 세제 70정</h1>
                            <h2>29,000원</h2>
                            <div id="heart"> 
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>잔여세제 걱정 없는 무계면 저자극 고체 세탁세제</b></p>
                                <br>
                                <br>
                                <h3>친환경 고체 세탁 세제 70정</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                                    ...
                                    <div class="total_price">
                                       <div class="total_price1"><b>총 합계금액</b></div>
                                        <div class="total_price2">
                                            <strong id="price">29000</strong> 원
                                        </div>                                              
                                    </div>
                                    <p/>
                                    <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_11_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_living_11_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_living_11_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_living_11_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <div class="de1">
                    <img src="../images/living_11_1.jpg">
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 29000) +29000;
