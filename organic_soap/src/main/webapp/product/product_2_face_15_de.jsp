            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="wishServlet">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_15.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_15.png" class="small">
                                 <img src="../images/face_15_1.png" class="small">
                                 <img src="../images/face_15_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>가꿈비누 페퍼민트</h1>
                            <h2>5,500원</h2>
                            <div id="heart"> 
                                <span class="material-symbols-outlined" id="icon"1 onclick="style.color='red',save()">favorite </span>
                            </div>
                </form> 
                            <hr>
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="26">
					<input type="hidden" name="cart_mem_key" value="<%= mem_key%>">
					
                            <div class="tt">
                                <p><b>가꿈비누 페퍼민트
                                    식물 유래 성분으로 만들어 안심하고 사용가능한 가꿈비누</b></p>
                                <br>
                                <br>
                                <h3>가꿈비누 페퍼민트</h3>
                                <p><b>배송 방법</b> 택배</p>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_15_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_15_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_15_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_15_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 5500) +5500;
