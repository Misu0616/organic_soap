            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="hair_8.png"> 
					<input type="hidden" name="pro_name" value="베러 댄 리퀴드 여행용 키트"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					          
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/hair_8.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/hair_8.png" class="small">
                                 <img src="../images/hair_8_1.png" class="small">
                                 <img src="../images/hair_8_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>베러 댄 리퀴드 여행용 키트</h1>
                            <h2>9,500원</h2>
                            <div id="heart"> 
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>일회용 액체 여행용품 대신, 지속가능한 일상을 위한 플라스틱 프리 고체 여행용 키트</b></p>
                                <br>
                                <br>
                                <h3>베러 댄 리퀴드 여행용 키트</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_hair_8_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_hair_8_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_hair_8_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_hair_8_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
