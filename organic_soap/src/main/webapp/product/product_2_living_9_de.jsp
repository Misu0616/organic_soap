            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="living_9.png"> 
					<input type="hidden" name="pro_name" value="동구밭 씹는 고체치약 45정"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					           
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/living_9.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/living_9.png" class="small">
                                 <img src="../images/living_9_1.png" class="small">
                                 <img src="../images/living_9_3.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>동구밭 씹는 고체치약 45정</h1>
                            <h2>11,000원</h2>
                            <div id="heart"> 
                                    ...
                                    <div class="total_price">
                                       <div class="total_price1"><b>총 합계금액</b></div>
                                        <div class="total_price2">
                                            <strong id="price">11000</strong> 원
                                        </div>                                              
                                    </div>
                                    <p/>
                                    <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_9_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_living_9_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_living_9_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_living_9_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <div class="de1">
                    <img src="../images/living_9_1.jpg">
                    <img src="../images/living_9_2.jpg">
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 11000) +11000;
