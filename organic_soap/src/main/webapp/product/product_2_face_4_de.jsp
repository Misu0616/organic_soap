            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="wishServlet">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_4.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_4.png" class="small">
                                 <img src="../images/face_4_9.png" class="small">
                                 <img src="../images/face_4_10.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>가꿈비누 5종 세트</h1>
                ...
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="16">
					<input type="hidden" name="cart_mem_key" value="<%= mem_key%>">
					
                            <div class="tt">
                                <p><b>식물 유래 성분으로 만들어 안심하고 사용가능한 가꿈비누</b></p>
                                <br>
                                <br>
                                <h3>꿈비누 5종 세트</h3>
                                <p><b>배송 방법</b> 택배</p>
                                    ...
                                    <div class="total_price">
                                       <div class="total_price1"><b>총 합계금액</b></div>
                                        <div class="total_price2">
                                            <strong id="price">26500</strong> 원
                                        </div>                                              
                                    </div>
                                    <p/>
                                    <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_4_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_4_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_4_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_4_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <div class="de1">
                    <img src="../images/face_4_1.png">
                    <img src="../images/face_4_2.png">
                    <img src="../images/face_4_3.png">
                    <img src="../images/face_4_4.png">
                    <img src="../images/face_4_5.png">
                    <img src="../images/face_4_6.png">
                    <img src="../images/face_4_7.png">
                    <img src="../images/face_4_8.png">
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 26500) +26500;
