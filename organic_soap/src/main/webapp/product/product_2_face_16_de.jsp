            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_16.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_16.png" class="small">
                                 <img src="../images/face_16_1.png" class="small">
                                 <img src="../images/face_16_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>가꿈비누 케일</h1>
                ...
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="27">
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_16_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_16_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_16_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_16_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
