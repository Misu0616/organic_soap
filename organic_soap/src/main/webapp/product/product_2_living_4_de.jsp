            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="living_4.png"> 
					<input type="hidden" name="pro_name" value="올비건 설거지 비누 녹차 100g"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					          
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/living_4.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/living_4.png" class="small">
                                 <img src="../images/living_4_1.png" class="small">
                                 <img src="../images/living_4_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>비건 설거지 비누 녹차 100g</h1>
                            <h2>8,000원</h2>
                            <div id="heart"> 
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>유기농 녹차를 함유하여 그릇에 밴 불쾌한 냄새제거에 도움을 주는 비건 설거지 비누</b></p>
                                <br>
                                <br>
                                <h3>비건 설거지 비누 녹차 100g</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_4_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_living_4_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_living_4_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_living_4_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 8000) +8000;
