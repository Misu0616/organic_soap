            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post" action="wishServlet">	
                    ...
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_21.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_21.png" class="small">
                                 <img src="../images/face_21_1.png" class="small">
                                 <img src="../images/face_21_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>올바른 바디비누 노니</h1>
                ...
                <form name="pro" method="post" action="productServlet">				
					...
					<input type="hidden" name="cart_pro_key" value="32">
					<input type="hidden" name="cart_mem_key" value="<%= mem_key%>">
					
                            <div class="tt">
                                <p><b>식물유래 성분을 담은 저자극 순한 바디워시가 깨끗한 세정과 피부 진정 케어를 동시에 도와줍니다.</b></p>
                                <br>
                                <br>
                                <h3>올바른 바디비누 노니</h3>
                                <p><b>배송 방법</b> 택배</p>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_21_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_21_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_21_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_21_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
