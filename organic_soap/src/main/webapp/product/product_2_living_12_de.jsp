            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="living_12.png"> 
					<input type="hidden" name="pro_name" value="올바른 세탁비누 소프넛 200g"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					          
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/living_12.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/living_12.png" class="small">
                                 <img src="../images/living_12_1.png" class="small">
                                 <img src="../images/living_12_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>올바른 세탁비누 소프넛 200g</h1>
                            <h2>7,000원</h2>
                            <div id="heart"> 
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>잔여 찌꺼기가 없어 아기 옷부터 생활 빨래가 가능한 세탁비누</b></p>
                                <br>
                                <br>
                                <h3>올바른 세탁비누 소프넛 200g</h3>
                                <p><b>배송 방법</b> 택배</p>
                                <p><b>배송비</b> 3,000원</p>
                            </div>
                            <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_living_12_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_living_12_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_living_12_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_living_12_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
                ...
                <div class="de1">
                    <img src="../images/living_12_1.jpg">
