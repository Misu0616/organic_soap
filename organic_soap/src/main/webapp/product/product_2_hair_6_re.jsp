            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="hair_6.png"> 
					<input type="hidden" name="pro_name" value="올바른 샴푸바 건성용"> 
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                ...
                                <div id="menu3"><a href="product_2_hair_6_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;<b>REVIEW</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_hair_6_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--리뷰 시작-->
