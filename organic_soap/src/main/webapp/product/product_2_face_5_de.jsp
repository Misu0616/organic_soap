            ...
            <!-- 본문 시작 -->
             <div class="every">
                ...
                <form name="pro" method="post"> 
					<input type="hidden" name="pro_img" value="face_5.png"> 
					<input type="hidden" name="pro_name" value="올바른 핸드크림 시어버터"> 
					<input type="hidden" name="pro_price" id="price11">
					<input type="hidden" name="pro_count" id="result11">
					          
                    <div class="po1">
                        <div id="po2">
                            <img src="../images/face_5.png" id="po3" onclick="displaySrc()">
                            <div id="small-pic">
                                 <img src="../images/face_5.png" class="small">
                                 <img src="../images/face_5_1.png" class="small">
                                 <img src="../images/face_5_2.png" class="small">
                             </div>
                         </div>
                        <div id="text">
                            <h1>올바른 핸드크림 시어버터</h1>
                        <h2>13,000원</h2>
                            ...
                            <hr>
                            <div class="tt">
                                <p><b>겉돌지 않고 밀착되는 수분 충전 저자극 무향 핸드크림</b></p>
                                <br>
                                <br>
                                <h3>올바른 핸드크림 시어버터</h3>
                                <p><b>배송 방법</b> 택배</p>
                                    ...
                                    <div class="total_price">
                                       <div class="total_price1"><b>총 합계금액</b></div>
                                        <div class="total_price2">
                                            <strong id="price">13000</strong> 원
                                        </div>                                              
                                    </div>
                                    <p/>
                                    <div>
                    ...
                    <div class="cate2" >
                        <div class="pos2">
                            <div class="menu">
                                <div id="menu1"><a href="product_2_face_5_de.jsp" style="color: rgb(93, 93, 93)"><b>DETAIL</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu2"><a href="product_2_face_5_gu.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;GUIDE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu3"><a href="product_2_face_5_re.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;REVIEW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/</a></div>
                                <div id="menu4"><a href="product_2_face_5_qa.jsp" style="color: rgb(93, 93, 93)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></div>
                            </div>
                        </div>
                     </div> 
                <!--상세페이지 시작-->   
...
function count(type)  {
            ...
            let total = (parseInt(a.textContent) * 13000) +13000;
